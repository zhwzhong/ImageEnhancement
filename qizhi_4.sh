...
# Test  --load_best True  --self_ensemble False --test_only False  --no_augmentation

python main.py --cuda_name '0' --num_GPUs 1 --data_name 'ImageRestoration'  --model 'MyNet' \
--num_features 64  --growth_rate 32 --num_groups 4 --num_blocks 23 --num_conv 4 --growth_rate 32 \
